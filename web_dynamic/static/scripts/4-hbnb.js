$(document).ready(function() {
    ...
    function fetchAndRenderPlaces(data) {
        $.ajax({
    ...
    $("button").click(function() {
        // Get IDs of checked amenities
        var checkedAmenities = $(".amenities input[type='checkbox']:checked").map(function() {
            return $(this).data("id");
        }).get();

        // Construct data object with checked amenity IDs
        var data = {
            amenities: checkedAmenities
        };

        // Fetch and render places based on checked amenities
        fetchAndRenderPlaces(data);
    });
